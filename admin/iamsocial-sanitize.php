 ...
 */
function iamsocial_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function iamsocial_sanitize_css( $css ) {
 ...
 */
function iamsocial_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function iamsocial_sanitize_email( $email, $setting ) {
 ...
 */
function iamsocial_sanitize_html( $html ) {
 ...
 */
function iamsocial_sanitize_image( $image, $setting ) {
 ...
 */
function iamsocial_sanitize_nohtml( $nohtml ) {
 ...
 */
function iamsocial_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function iamsocial_sanitize_number_range( $number, $setting ) {
 ...
 */
function iamsocial_sanitize_select( $input, $setting ) {
 ...
 */
function iamsocial_sanitize_url( $url ) {
